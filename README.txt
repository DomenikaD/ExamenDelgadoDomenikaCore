...
a persistence unit "Examen64DelgadoDomenikaCorePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Examen64DelgadoDomenikaCore/pom.xml":
...
artifact ("Examen64DelgadoDomenikaCore.war") is already built. You can build
